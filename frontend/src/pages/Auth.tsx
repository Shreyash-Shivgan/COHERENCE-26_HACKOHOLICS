...
// //                   required
// //                   className="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent sm:text-sm bg-slate-50 focus:bg-white transition-colors"
// //                   placeholder={role === 'admin' && !isLogin ? "name@gov.in" : "name@example.com"}
// //                 />
// //               </div>
// //             </div>
...
//               type="submit"
//               disabled={isLoading}
//               className="w-full flex justify-center items-center gap-2 py-2.5 px-4 rounded-lg text-white bg-blue-600 hover:bg-blue-700"
//             >
//               {isLoading ? (
