    ...
    return (
      <div className="space-y-5">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 text-center">
          ...
          <h3 className="text-lg font-bold text-amber-800 mb-2">Aadhaar Verification Required</h3>
          <p className="text-sm text-amber-700 max-w-md mx-auto leading-relaxed mb-6">
            To file reports and complaints, you must first verify your identity using your Aadhaar card.
            Go to your <strong>Profile</strong> page and complete the Aadhaar verification process.
          </p>
          <button
